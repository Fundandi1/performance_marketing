    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('BRAND', 'Brand'), ('AGENCY', 'Agency')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('annual_ad_spend', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('competitiveness_score', models.PositiveIntegerField(default=50)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
